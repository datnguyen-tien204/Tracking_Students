...
def main():
    ...
    CLASSIFIER_PATH = r'D:\Facenet+Mtcnn_Project\Facenet+Mtcnn_Project_main\Models\facemodel.pkl'
    VIDEO_PATH = args.path
    FACENET_MODEL_PATH = r'D:\Facenet+Mtcnn_Project\Facenet+Mtcnn_Project_main\Models\20180402-114759.pb'
    SRC_PATH=r"D:\Facenet+Mtcnn_Project\Facenet+Mtcnn_Project_main\src\align"
                ...
                try:
                    ...
                    if faces_found > 0:
                        ...
                        for i in range(faces_found):
                            ...
                            cv2.putText(frame, "Xac suat: "+str(round(best_class_probabilities[0], 3)), (text_x, text_y + 17),
