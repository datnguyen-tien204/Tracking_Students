...
baseUrl='https://api.telegram.org/bot6374709841:AAEFa1PDP9q6Vo52C8WvXvRiZ66Xou7rqec/sendPhoto'

def main(probability_threshold, camera, stframe):
    ...
    CLASSIFIER_PATH = r'D:\Facenet+Mtcnn_Project\Facenet+Mtcnn_Project\Models\model_saved.pkl'
    FACENET_MODEL_PATH = r'D:\Facenet+Mtcnn_Project\Facenet+Mtcnn_Project\Models\20180402-114759.pb'
    ALIGNMENT_MODEL_PATH = r"D:\Facenet+Mtcnn_Project\Facenet+Mtcnn_Project\src\align"
...
if __name__=='__main__':
    main(0.8,r'D:\Data Trainning\Donand_J_Trump',0)
